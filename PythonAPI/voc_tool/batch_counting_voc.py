...
# * Create time   : 2017-03-16 03:54
# * Last modified : 2017-03-16 03:54
# * Filename      : batch_counting_voc.py
# * Description   :
...
anno_sets = ["VOC2007","VOC2012", "VOC2007test"]
data_types = ["val", "train", "test"]
...
for i in xrange(0, len(anno_sets)):
    ...
    imgset_dir = "{}/{}/ImageSets/Main".format(voc_data_dir, anno_set)
    for j in range(len(data_types)):
        data_type = data_types[j]
        imgset_file = "{}/{}.txt".format(imgset_dir, data_type)
        if os.path.exists(imgset_file) is not True:
            continue
        ...
        if redo or not os.path.exists(anno_out_dir):
            cmd = "python {}/counting_voc.py {} {} {} {} {} {}" \
                    .format(CURDIR, anno_dir, imgset_file, anno_set, data_type, anno_out_dir, img_out_dir)
            print cmd
